...
import StateClass, {StateClass1} from "./StateClass";
import StateFunctional, {StateFunctional1} from "./StateFunctional"; 
import ClassComp from "./ClassCompFragments"; 
import ClassCompProps from "./ClassCompProp";  

import ClassCompFragments from "./ClassCompFragments";
import ClassCompProp from "./ClassCompProp";
import FunctionalCompFragments from "./FunctionalCompFragments";
import FunctionalCompProp from "./FunctionalCompProp";  
import FunctionalCompParam from "./FunctionalCompParam";
import Destructuring from "./Destructuring";
import SpreadOpFragments from "./SpreadOpFragments";
